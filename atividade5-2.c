...
void funcao1(void* threadarg) {
  ...
  sleep(1);//Substituindo a LINHA A por um sleep(1) acaba resultando em um atraso para a atribuição do valor
           //1 para a variável X logo, a saída resulta em 2 sempre, pois a alteração do valor de y acontece
           //sempre antes que o X receba 1.
  x = 1;
  // LINHA B
  if (y == 0)
    printf("1 \n");
